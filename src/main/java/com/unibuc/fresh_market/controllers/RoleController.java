...
import com.unibuc.fresh_market.services.RoleService.RoleService;
...
public class RoleController {
    ...
    @PutMapping("/{roleId}")
    public ResponseEntity<?> updateRole(@RequestBody @Valid Role role, @PathVariable String roleId) {
        Integer id = Integer.parseInt(roleId);
