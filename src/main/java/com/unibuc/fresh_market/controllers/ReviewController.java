...
import com.unibuc.fresh_market.services.ReviewService.ReviewService;
...
public class ReviewController {
    ...
    @PutMapping("/{reviewId}")
    public ResponseEntity<?> updateReview(@RequestBody @Valid Review review, @PathVariable String reviewId) {
        Integer id = Integer.parseInt(reviewId);
