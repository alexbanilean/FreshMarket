...
import com.unibuc.fresh_market.services.DeliveryService.DeliveryService;
...
public class DeliveryController {
    ...
    @PostMapping
    public ResponseEntity<?> createDelivery(@RequestBody @Valid Delivery delivery) {
    ...
    public ResponseEntity<?> updateDelivery(@RequestBody @Valid Delivery delivery, @PathVariable String deliveryId) {
        Integer id = Integer.parseInt(deliveryId);
    ...
    @GetMapping("/status")
    public ResponseEntity<?> getDeliveriesByStatus(@RequestBody @Valid String status) {
